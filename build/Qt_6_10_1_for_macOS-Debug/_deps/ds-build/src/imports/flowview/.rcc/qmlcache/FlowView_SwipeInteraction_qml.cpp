...
0xc,0x16,0x0,0x0,0x95,0x46,0xbc,0x69,
0xae,0x15,0x79,0x25,0xbe,0x86,0x44,0xeb,
0x61,0xc3,0xbc,0xc2,0x0,0x0,0x0,0x0,
0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,
...
0x5f,0x0,0x0,0x0,0xfc,0x0,0x0,0x0,
...
aotContext->setInstructionPointer(2);
#endif
while (!aotContext->loadContextIdLookup(93, &s.v2_0)) {
#ifdef QT_NO_DEBUG
aotContext->setInstructionPointer(2);
#endif
...
aotContext->setInstructionPointer(4);
#endif
while (!aotContext->getObjectLookup(94, s.v2_0, &s.v2_2)) {
#ifdef QT_NO_DEBUG
aotContext->setInstructionPointer(4);
#endif
aotContext->initGetObjectLookup(94, s.v2_0);
if (aotContext->engine->hasError()) {
aotContext->setReturnValueUndefined();
if (argv[0]) {
    *static_cast<bool *>(argv[0]) = bool();
